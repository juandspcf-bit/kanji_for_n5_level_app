...
import 'package:kanji_for_n5_level_app/presentation_layer/screens/quiz_kanji_list_screen/score_screen/score_kanji_list_provider.dart';
...
class QuizDataValuesProvider extends Notifier<QuizDataValues> {
  ...
  (int, int, int) getCounts() {
    int countCorrects = state.isCorrectAnswer.map((e) {
      if (e == true) {
        return 1;
      }
      return 0;

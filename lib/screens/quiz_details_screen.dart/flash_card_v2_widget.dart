...
class FlashCardV2Widget extends ConsumerStatefulWidget {
  final String japanese;
  final String english;
  final double height;
  final double width;

  const FlashCardV2Widget({
    super.key,
  ...
  @override
  ConsumerState<FlashCardV2Widget> createState() => _FlashCardV2WidgetState();
}

class _FlashCardV2WidgetState extends ConsumerState<FlashCardV2Widget> {

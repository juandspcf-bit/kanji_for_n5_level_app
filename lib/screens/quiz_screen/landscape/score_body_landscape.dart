...
class ScoreBodyLandscape extends ConsumerStatefulWidget {
  const ScoreBodyLandscape({
    super.key,
  ...
  @override
  ConsumerState<ScoreBodyLandscape> createState() => _ScoreBodyState();
}

class _ScoreBodyState extends ConsumerState<ScoreBodyLandscape> {
  double _opacity = 1.0;
        ...
        children: [
          Column(
            children: [
              ...
              Text(
                "This is the stats of your quiz landscape",
